  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50/30 to-blue-50/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Stats Cards */}
        <AnimateOnView className="animate-scale" delay={200} threshold={0.2}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* Recent Activity */}
            <AnimateOnView className="animate-fade-left" delay={300} threshold={0.15}>
            ...
            {/* Saved Searches */}
            <AnimateOnView className="animate-fade-left" delay={400} threshold={0.15}>
              <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border border-white/20 p-6">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            {/* Quick Actions */}
            <AnimateOnView className="animate-fade-right" delay={400} threshold={0.15}>
              <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border border-white/20 p-6">
            ...
            {/* Market Insights */}
            <AnimateOnView className="animate-fade-right" delay={500} threshold={0.15}>
              <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border border-white/20 p-6">
